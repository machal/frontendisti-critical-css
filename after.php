...
<html lang="cs">
  ...
  <head>
    ...
    <script>
      <?php
        // https://github.com/filamentgroup/enhance/blob/master/enhance.js
        include "dist/js/lib/enhance.min.js"
      ?>
    </script>
...
<!-- Hlavni obsah -->
      ...
      <div class="content" role="main">
        ...
        <p class="photo">
          <img src="dist/img/content/orion_1.jpg" alt="Orion" width="1600" height="899">
        </p>
    ...
    <script src="dist/js/script.js" async></script>
